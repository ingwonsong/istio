...
type VersionLists struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ValidClusterVersions *VersionList `protobuf:"bytes,1,opt,name=valid_cluster_versions,json=validClusterVersions,proto3,oneof" json:"valid_cluster_versions,omitempty"`
}

func (x *VersionLists) Reset() {
	*x = VersionLists{}
...
func (x *VersionLists) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VersionLists) ProtoMessage() {}

func (x *VersionLists) ProtoReflect() protoreflect.Message {
	mi := &file_version_proto_msgTypes[0]
...
// Deprecated: Use VersionLists.ProtoReflect.Descriptor instead.
func (*VersionLists) Descriptor() ([]byte, []int) {
	return file_version_proto_rawDescGZIP(), []int{0}
}

func (x *VersionLists) GetValidClusterVersions() *VersionList {
	if x != nil {
		return x.ValidClusterVersions
	}
	return nil
}
...
var file_version_proto_rawDesc = []byte{
	,
...
var file_version_proto_goTypes = []interface{}{
	(*VersionLists)(nil), // 0: VersionLists
	(*VersionList)(nil),  // 1: VersionList
}
var file_version_proto_depIdxs = []int32{
	1, // 0: VersionLists.valid_cluster_versions:type_name -> VersionList
...
func file_version_proto_init() {
	...
	file_version_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
