...
func NewSelfSignedIstioCAOptions(ctx context.Context,
	...
	// TODO(jaellio): Implement istio-ca-secret to cacerts Secret migration. If only a istio-ca-secret
	// exists, create a new cacerts secret and load the cacerts data. Currently, if
	// USE_CACERTS_FOR_SELF_SIGNED_CA is enabled we ignore an existing istio-ca-secret and create a
	// new cacerts.
	caCertName := CASecret
