...
var (
	...
	// CSM: Overriding the ENABLE_DEFERRED_CLUSTER_CREATION flag to false
	// For more info, refer here: b/365710553
	EnableDeferredClusterCreation = env.Register("ENABLE_DEFERRED_CLUSTER_CREATION", false,
